...
const FILES = [
  ...
  ['5 Secondhand/TA6 Secondhand Inset 3-SHS in Europe.xlsx', '5-map3a.csv'],
  ['5 Secondhand/TA6 Secondhand Inset 3-SHS in Europe.xlsx', '5-map3b.csv'],
  ...
  ['9 Societal Harms/TA6 Societal Map (web).xlsx', '9-map.csv'],
  ...
  ['Web Smokeless/TA6 Smokeless Inset Carcinogens.xlsx', 'smokeless-2.csv'],
...
(async () => {
  await Promise.all(FILES.map(f => {
    const inFile = path.join(INPUT_DATA_DIR, f[0]);
    const outFile = path.join(OUTPUT_DATA_DIR, f[1]);
